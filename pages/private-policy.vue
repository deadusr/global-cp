<template>
    <div class="from-[#666FCC] to-[#202342] bg-gradient-to-b min-h-screen">
        <header class="container flex items-center justify-between py-4">
            <span class="font-bold text-white text-base justify-between font-mono">
                Global Construction<br />
                Platform Corp
            </span>
            <button
                class="px-4 py-2 font-bold text-sm text-white rounded-full bg-gradient-to-br from-[#C77ACC] to-[#CCBE7A]">Get
                in
                touch</button>
        </header>
        ...
        <section class="container mx-auto text-white flex flex-col items-center gap-9">
            <div class="flex flex-col gap-5 py-12 w-full mx-auto">
                <h2 class="text-white text-3xl md:text-4xl lg:text-5xl font-mono text-center ">
                    Privacy Policy
                </h2>

                <div class="text-base font-sans">
                    <br />
                    <br/><h2 class="text-3xl">PRIVACY NOTICE</h2><br/>
                    <p>Last updated <span>20.04.2025</span></p>
                    <p>This privacy notice for <code>Global Construction Platform Corp</code>
                        (&#8220;<strong>Company</strong>,&#8221; &#8220;<strong>we</strong>,&#8221;
                        &#8220;<strong>us</strong>,&#8221; or &#8220;<strong>our</strong>&#8220;), describes how and why
                        we might collect, store, use, and/or share (&#8220;<strong>process</strong>&#8220;) your
                        information when you use our services (&#8220;<strong>Services</strong>&#8220;), such as when
                        you:</p>
                    <br/><ul class="list-disc list-inside">
                        <li>Visit our website at <a href="https://global-cp.net"
                                class="underline">https://global-cp.net</a>, or any
                            website of
                    ...
                    <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your
                        ...
                        use our Services. If you still have any questions or concerns, please contact us at <span
                            class="underline">globalcp23@gmail.com</span>.</p>
                    <p>This privacy policy was created by Termly&#8217;s <a
                            href="https://termly.io/products/privacy-policy-generator/" target="_blank"
                            rel="noopener">Privacy Policy Generator</a>.</p>
                    <br/><h3 class="text-2xl">SUMMARY OF KEY POINTS</h3> <br/>
                    <p><strong><em>This summary provides key points from our privacy notice, but you can find out more
                                ...
                                section you are looking for.</em></strong></p>
                    <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our
                        Services, we may process personal information depending on how you interact with <span>Global
                            Construction Platform Corp</span> and the Services, the choices you make, and
                    ...
                    <p><strong>Do you receive any information from third parties?</strong> We may receive information
                        from public databases, marketing partners, social media platforms, and other outside sources.
                    </p>
                    <p><strong>How do you process my information?</strong> We process your information to provide,
                        ...
                        consent. We process your information only when we have a valid legal reason to do so.</p>
                    ...
                    <p><strong>How do I exercise my rights?</strong> The easiest way to exercise your rights is by
                        contacting us. We will consider and act upon any request in
                        accordance with applicable data protection laws.</p>
                    <p>Want to learn more about what <span>Global Construction Platform Corp</span> does with any
                        information we collect? Review the notice in full below.</p>
                    <br/><h3 class="text-2xl">TABLE OF CONTENTS</h3> <br/>
                    ...
                    <br/><h3 class="text-2xl">1. WHAT INFORMATION DO WE COLLECT?</h3> <br/>
                    ...
                    <p><strong>Sensitive Information.</strong> We do not process
                    ...
                    <p><em><strong>In Short:</strong> Some information — such as your Internet Protocol (IP) address
                    ...
                    <p><em><strong>In Short:</strong> We may collect limited data from public databases, marketing
                    ...
                    <br/><h3 class="text-2xl">2. HOW DO WE PROCESS YOUR INFORMATION?</h3> <br/>
                    <p><em><strong>In Short:</strong> We process your information to provide, improve, and administer
                    ...
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li><strong>To enable user-to-user communications.</strong> We may process your information if
                            you choose to use any of our offerings that allow for communication with another user.</li>
                        ...
                        <li><strong>To send you marketing and promotional communications.</strong> We may process the
                            ...
                            more information, see &#8220;<em>WHAT ARE YOUR PRIVACY RIGHTS?</em>&#8221; below.</li>
                        ...
                        <li><strong>To determine the effectiveness of our marketing and promotional campaigns.</strong>
                            We may process your information to better understand how to provide marketing and
                            promotional campaigns that are most relevant to you.</li>
                        <li><strong>To save or protect an individual&#8217;s vital interest.</strong> We may process
                            your information when necessary to save or protect an individual’s vital interest, such as
                            to prevent harm.</li>
                    </ul> <br/>
                    <br/><h3 class="text-2xl">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h3> <br/>
                    <p><em><strong>In Short:</strong> We only process your personal information when we believe it is
                    ...
                    <p><strong><em><u>If you are located in the EU or UK, this section applies to you.</u></em></strong>
                    </p>
                    ...
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li><strong>Performance of a Contract.</strong> We may process your personal information when we
                            ...
                            our Services or at your request prior to entering into a contract with you.</li>
                        <li><strong>Legitimate Interests.</strong> We may process your information when we believe it is
                            ...
                            <br/><ul class="list-disc list-inside">
                                <li>Send users information about special offers and discounts on our products and
                                    services</li>
                        ...
                        <li><strong>Legal Obligations.</strong> We may process your information where we believe it is
                            ...
                            information as evidence in litigation in which we are involved.</li>
                    ...
                    <p>In legal terms, we are generally the “data controller” under European data protection laws of the
                        ...
                        know more about our customers&#8217; privacy practices, you should read their privacy policies
                        and direct any questions you have to them.</p>
                    ...
                    <p>We may process your information if you have given us specific permission (i.e., express consent)
                        ...
                        can be inferred (i.e., implied consent). You can withdraw your consent at any time.</p>
                    ...
                    <br/><h3 class="text-2xl">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3> <br/>
                    <p><em><strong>In Short:</strong> We may share information in specific situations described in this
                            section and/or with the following categories of third parties.</em></p>
                    <p><strong>Vendors, Consultants, and Other Third-Party Service Providers.</strong> We may share your
                        data with third-party vendors, service providers, contractors, or agents (“<strong>third
                            parties</strong>”) who perform services for us or on our behalf and require access to such
                        ...
                        third parties we may share personal information with are as follows:</p>
                    <br/><ul class="list-disc list-inside">
                        <li>Ad Networks</li>
                    ...
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li><strong>Affiliates.</strong> We may share your information with our affiliates, in which
                            case we will require those affiliates to honor this privacy notice. Affiliates include our
                    ...
                    <br/><h3 class="text-2xl">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3> <br/>
                    <p><em><strong>In Short:</strong> We are not responsible for the safety of any information that you
                            share with third parties that we may link to or who advertise on our Services, but are not
                            affiliated with, our Services.</em></p>
                    <p>The Services, may link to
                        third-party websites, online services, or mobile applications and/or contain advertisements from
                        third parties that are not affiliated with us and which may link to other websites, services, or
                        applications. Accordingly, we do not make any guarantee regarding any such third parties, and we
                        ...
                        data you provide to any third parties. Any data collected by third parties is not covered by
                        this privacy notice. We are not responsible for the content or privacy and security practices
                        and policies of any third parties, including other websites, services, or applications that may
                        be linked to or from the Services. You should review the policies of such third parties and
                        contact them directly to respond to your questions.</p>
                    <br/><h3 class="text-2xl">6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3> <br/>
                    <p><em><strong>In Short:</strong> We may use cookies and other tracking technologies to collect and
                            store your information.</em></p>
                    <br/><h3 class="text-2xl">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3> <br/>
                    <p><em><strong>In Short:</strong> If you choose to register or log in to our services using a social
                            media account, we may have access to certain information about you.</em></p>
                    ...
                    <br/><h3 class="text-2xl">8. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h3> <br/>
                    <p><em><strong>In Short:</strong> We may transfer, store, and process your information in countries
                            other than your own.</em></p>
                    <p>Our servers are located in worldwide. If you are accessing our Services from outside</p>
                    ...
                    <p>We have implemented measures to protect your personal information, including by using the
                        ...
                        between our group companies and between us and our third-party providers. These clauses require
                        all recipients to protect all personal information that they process originating from the EEA or
                        UK in accordance with European data protection laws and regulations. We have implemented
                        similar appropriate safeguards with our third-party service providers and partners and further
                    ...
                    <p>These include a set of Binding Corporate Rules (&#8220;BCRs&#8221;) established and implemented
                        by Global Construction Platform Corp. Our BCRs have been recognized by EEA and
                        UK data protection authorities as providing an adequate level of protection to the personal
                        information we process internationally.</p>
                    <p>Global Construction Platform Corp adheres to and complies with the Privacy
                        Shield Principles when processing personal information from the
                        EU-US. If we have received your personal information
                        in the United States and subsequently transfer that information to a third party acting as our
                        agent, and such third party agent processes your personal information in a manner inconsistent
                        with the Privacy Shield Principles, we will remain liable unless we can prove we are not
                        responsible for the event giving rise to the damage.</p>
                    <p>With respect to personal information received or transferred pursuant to the Privacy Shield
                        Framework, Global Construction Platform Corp is subject to the investigatory and enforcement
                        powers of the US Federal Trade
                    ...
                    <p>If you have any questions or concerns relating to Global Construction Platform Corp’s Privacy
                        Shield certification, please write to us at the contact details
                        below. We commit to resolving any complaints or disputes about our collection and use of your
                        personal information under the Privacy Shield.
                    </p>
                    <br/><h3 class="text-2xl">9. HOW LONG DO WE KEEP YOUR INFORMATION?</h3> <br/>
                    <p><em><strong>In Short:</strong> We keep your information for as long as necessary to fulfill the
                            purposes outlined in this privacy notice unless otherwise required by law.</em></p>
                    ...
                    <br/><h3 class="text-2xl">10. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3> <br/>
                    <p><em><strong>In Short:</strong> We aim to protect your personal information through a system of
                    ...
                    <br/><h3 class="text-2xl">11. DO WE COLLECT INFORMATION FROM MINORS?</h3> <br/>
                    <p><em><strong>In Short:</strong> We do not knowingly collect data from or market to children under
                            18 years of age.</em></p>
                    <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the
                        ...
                        globalcp23@gmail.com.
                    </p>
                    <br/><h3 class="text-2xl">12. WHAT ARE YOUR PRIVACY RIGHTS?</h3> <br/>
                    <p><em><strong>In Short:</strong> In some regions, such as the European Economic Area (EEA), United
                    ...
                    <p>If you are located in the EEA or UK and you believe we are unlawfully processing your personal
                        ...
                        authority. You can find their contact details here: <a
                            href="https://edpb.europa.eu/about-edpb/about-edpb/members_en" target="_blank"
                            rel="noopener">https://edpb.europa.eu/about-edpb/about-edpb/members_en</a>.</p>
                    <p>If you are located in Switzerland, the contact details for the data protection authorities are
                        available here: <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" target="_blank"
                            rel="noopener">https://www.edoeb.admin.ch/edoeb/en/home.html</a>.</p>
                    <p><strong><u>Withdrawing your consent:</u></strong> If we are relying on your consent to process
                        ...
                        &#8220;<em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>&#8221; below or updating your
                        preferences.</p>
                    ...
                    <p><strong><u>Opting out of marketing and promotional communications:</u></strong> You can
                        ...
                        unsubscribe link in the emails that we send, replying “STOP” or “UNSUBSCRIBE” to the SMS
                        messages that we send, or by contacting us using
                        the details provided in the section &#8220;<em>HOW CAN YOU CONTACT US ABOUT THIS
                            NOTICE?</em>&#8221; below. You will then be removed from the marketing lists — however, we
                    ...
                    <p>If you have questions or comments about your privacy rights, you may email us at
                        globalcp23@gmail.com.</p>
                    <br/><h3 class="text-2xl">13. CONTROLS FOR DO-NOT-TRACK FEATURES</h3> <br/>
                    ...
                    <br/><h3 class="text-2xl">14. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3> <br/>
                    <p><em><strong>In Short:</strong> Yes, if you are a resident of California, you are granted specific
                            rights regarding access to your personal information.</em></p>
                    ...
                    <p style="padding-left: 40px;">(1) every individual who is in the State of California for other than
                        a temporary or transitory purpose and<br />
                    ...
                    <p>&nbsp;</p>
                    <p>Category L information may be used, or disclosed to a service provider or contractor, for
                    ...
                    <p>>Global Construction Platform Corp collects and shares your personal information
                        through:</p>
                    <br/><ul class="list-disc list-inside">
                    ...
                    <p>You may contact us by referring to the contact details at
                    ...
                    <p>We may disclose your personal information with our service providers pursuant to a written
                        ...
                        obligations mandated by the CCPA.</p>
                    ...
                    <p>Global Construction Platform Corp has disclosed the following categories of
                        personal information to third parties for a business or commercial purpose in the preceding
                        twelve (12) months:</p>
                    <br/><ul class="list-disc list-inside">
                        <li>Category A. Identifiers, such as contact details like your real name, alias, postal address,
                            telephone or mobile contact number, unique personal identifier, online identifier, Internet
                            Protocol address, email address, and account name.</li>
                        <li>Category B. Personal information, as defined in the California Customer Records law, such as
                            ...
                            information.</li>
                        <li>Category C. Characteristics of protected classifications under California or federal law,
                            such as gender or date of birth.</li>
                        <li>Category D. Commercial information, such as transaction information, purchase history,
                            financial details, and payment information.</li>
                        <li>Category E. Biometric information, such as fingerprints and voiceprints.</li>
                        <li>Category F. Internet or other electronic network activity information, such as browsing
                            history, search history, online behavior, interest data, and interactions with our and other
                            websites, applications, systems, and advertisements.</li>
                        <li>Category G. Geolocation data, such as device location.</li>
                        <li>Category H. Audio, electronic, visual, and similar information, such as images and audio,
                            video, or call recordings created in connection with our business activities.</li>
                        <li>Category I. Professional or employment-related information, such as business contact details
                            in order to provide you our services at a business level or job title, work history, and
                            professional qualifications if you apply for a job with us.</li>
                        <li>Category J. Education information, such as student records and directory information.</li>
                        <li>Category K. Inferences drawn from any of the personal information listed above to create a
                            profile or summary about, for example, an individual&#8217;s preferences and
                            characteristics.</li>
                        <li>Category L. Sensitive personal information, such as account login information,
                            drivers&#8217; licenses, health data, precise geolocation, racial or ethnic origin,
                            religious or philosophical beliefs, and sex life or sexual orientation.</li>
                    </ul> <br/>
                    <p>The categories of third parties to whom we disclosed personal information for a business or
                        commercial purpose can be found under &#8220;<em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL
                            INFORMATION?</em>&#8220;.</p>
                    <p>Global Construction Platform Corp has not sold or shared any
                            personal information to
                            third parties for a business or commercial purpose in the preceding twelve (12)
                            months.</p>
                    <br/><ul class="list-disc list-inside">
                        <li>Category A. Identifiers, such as contact details, like your
                                ...
                                name.</li>
                        <li>Category B. Personal information, as defined in the California
                                Customer Records law, such as your name, contact information, education, employment,
                                employment history, and financial information.</li>
                        <li>Category C. Characteristics of protected classifications under
                                California or federal law, such as gender or date of birth.</li>
                        <li>Category D. Commercial information, such as transaction
                                information, purchase history, financial details, and payment information.</li>
                        <li>Category E. Biometric information, such as fingerprints and
                                voiceprints.</li>
                        <li>Category F. Internet or other electronic network activity
                                information, such as browsing history, search history, online behavior, interest data,
                                and interactions with our and other websites, applications, systems, and
                                advertisements.</li>
                        <li>Category G. Geolocation data, such as device location.
                        </li>
                        <li>Category H. Audio, electronic, visual, and similar
                                information, such as images and audio, video or call recordings created in connection
                                with our business activities.</li>
                        <li>Category I. Professional or employment-related information,
                                such as business contact details in order to provide you our services at a business
                                level or job title, work history, and professional qualifications if you apply for a job
                                with us.</li>
                        <li>Category J. Education information, such as student records and
                                directory information.</li>
                        <li>Category K. Inferences drawn from any of the personal
                                information listed above to create a profile or summary about, for example, an
                                individual&#8217;s preferences and characteristics.</li>
                        <li>Category L. Sensitive personal information, such as account
                                login information, drivers&#8217; licenses, health data, precise geolocation, racial or
                                ethnic origin, religious or philosophical beliefs, and sex life or sexual
                                orientation.</li>
                    </ul> <br/>
                    ...
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li>Retargeting Platforms</li>
                        <li>Social Networks</li>
                        <li>User Account Registration &amp; Authentication Services
                        </li>
                    </ul> <br/>
                    <p>The categories of third parties to whom we shared personal
                            information with are:</p>
                    <br/><ul class="list-disc list-inside">
                        <li>Ad Networks</li>
                        <li>Affiliate Marketing Programs</li>
                        <li>Data Analytics Services</li>
                    ...
                    <p>You can ask for the deletion of your personal information. If you ask us to delete your personal
                        ...
                        obligation, or any processing that may be required to protect against illegal activities.</p>
                    ...
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li>the business or commercial purpose for collecting, sharing, or selling personal information;
                            and</li>
                   ...
                   We do not process consumer&#8217;s sensitive personal information. /
                    ...
                    <br/><ul class="list-disc list-inside">
                        <li>social security information, drivers&#8217; licenses, state ID
                                cards, passport numbers</li>
                        <li>account login information</li>
                        <li>credit card numbers, financial account information, or
                                credentials allowing access to such accounts</li>
                        <li>precise geolocation</li>
                        <li>racial or ethnic origin, religious or philosophical beliefs,
                                union membership</li>
                        <li>the contents of email and text, unless the business is the
                    ...
                    <p>you have the right to direct that business to limit its use of your
                            sensitive personal information to that use which is necessary to perform the
                            Services.</p>
                    <p>Once a business receives your request, they are no longer allowed
                            to use or disclose your sensitive personal information for any other purpose unless you
                            provide consent for the use or disclosure of sensitive personal information for additional
                            purposes.</p>
                    <p>Please note that sensitive personal Information that is collected
                            or processed without the purpose of inferring characteristics about a consumer is not
                            covered by this right, as well as the publicly available information.</p>
                    <p>To exercise your right to limit use and disclosure of sensitive
                            personal Information, please email globalcp23@gmail.com .
                    </p>
                            ...
                            <br/><ul class="list-disc list-inside">
                                <li style="list-style-type: none;">
                                    <br/><ul class="list-disc list-inside">
                                        ...
                                        <li>You may request correction of your personal data if it is incorrect or no
                                            longer relevant, or ask to restrict the processing of the information.</li>
                                        <li>You can designate an authorized agent to make a request under the CCPA on
                                        ...
                                        <li>ou may request to opt out from future
                                            ...
                                            the request submission.</li>
                                    </ul> <br/>
                                </li>
                            </ul> <br/>
                        </li>
                    </ul> <br/>
                    <p>To exercise these rights, you can contact us by email at globalcp23@gmail.com, or by
                        referring to the contact details at the bottom of this document. If you have a complaint about
                        how we handle your data, we would like to hear from you.</p>
                    <p><strong>Financial Incentives</strong></p>
                    <p>&#8220;Financial incentive&#8221; means a program, benefit, or other offering, including payments
                        to consumers as compensation, for the disclosure, deletion, sharing, or sale of personal
                        information.</p>
                    <p>The law permits financial incentives or a price or service difference if it is reasonably related
                        to the value of the consumer’s data. A business must be able to explain how the financial
                        incentive or price or service difference is reasonably related to the value of the consumer’s
                        data. The explanation must include:</p>
                    <br/><ul class="list-disc list-inside">
                        <li style="list-style-type: none;">
                            <br/><ul class="list-disc list-inside">
                                <li style="list-style-type: none;">
                                    <br/><ul class="list-disc list-inside">
                                        <li>a good-faith estimate of the value of the consumer’s data that forms the
                    ...
                    <br/><h3 class="text-2xl">15. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3> <br/>
                    <p><em><strong>In Short:</strong> Yes, if you are a resident of Virginia, you may be granted
                            specific rights regarding access to and use of your personal information.</em></p>
                    <p><strong>Virginia CDPA Privacy Notice</strong></p>
                    <p>Under the Virginia Consumer Data Protection Act (CDPA):</p>
                    <p>&#8220;Consumer&#8221; means a natural person who is a resident of the Commonwealth acting only
                        in an individual or household context. It does not include a natural person acting in a
                        commercial or employment context.</p>
                    <p>&#8220;Personal data&#8221; means any information that is linked or reasonably linkable to an
                        ...
                        de-identified data or publicly available information.</p>
                    <p>&#8220;Sale of personal data&#8221; means the exchange of personal data for monetary
                        consideration.</p>
                    <p>If this definition of &#8220;consumer&#8221; applies to you, we must adhere to certain rights and
                        obligations regarding your personal data.</p>
                    <p>The information we collect, use, and disclose about you will vary depending on how you interact
                        with Global Construction Platform Corp and our Services. To find out more,
                        please visit the following sections above:</p>
                    <br/><ul class="list-disc list-inside">
                    ...
                    <p><span style="text-decoration: underline;">Your rights with respect to your personal data</span>
                    </p>
                    <br/><ul class="list-disc list-inside">
                        ...
                        <li>Right to opt out of the processing of your personal data if it is used for targeted
                            ...
                            produce legal or similarly significant effects</li>
                    </ul> <br/>
                    <p><span style="text-decoration: underline;">Exercise your rights provided under the Virginia
                            CDPA</span></p>
                    <p>You can opt out from the selling of your personal data, targeted
                        advertising, or profiling by disabling cookies in Cookie Preference Settings</p>
                    <p>You may contact us by email at globalcp23@gmail.com, by referring to the contact details
                        at the bottom of this document.
                    </p>
                    <p>If you are using an authorized agent to exercise your rights, we may deny a request if the
                    ...
                    <p>We may request that you provide additional information reasonably necessary to verify you and
                        your consumer&#8217;s request. If you submit the request through an authorized agent, we may
                        need to collect additional information to verify your identity before processing your request.
                    </p>
                    <p>Upon receiving your request, we will respond without undue delay, but in all cases, within
                        ...
                        initial 45-day response period, together with the reason for the extension.</p>
                    <p><span style="text-decoration: underline;">Right to appeal</span></p>
                    <p>If we decline to take action regarding your request, we will inform you of our decision and
                        reasoning behind it. If you wish to appeal our decision, please email us at
                        globalcp23@gmail.com.
                        Within sixty (60) days of receipt of an
                        appeal, we will inform you in writing of any action taken or not taken in response to the
                        appeal, including a written explanation of the reasons for the decisions. If your appeal is
                        denied, you may contact the Attorney General to <a
                            ...
                            target="_blank" rel="noopener">submit a complaint</a>.</p>
                    <br/><h3 class="text-2xl">16. DO WE MAKE UPDATES TO THIS NOTICE?</h3> <br/>
                    <p><em><strong>In Short:</strong> Yes, we will update this notice as necessary to stay compliant
                    ...
                    <br/><h3 class="text-2xl">17. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3> <br/>
                    <p>Based on the applicable laws of your country, you may have the right to request access to the
                        ...
                        circumstances. To request to review, update, or delete your personal information, please contact
                        us by email globalcp23@gmail.com
                    </p>
                </div>
            </div>
        </section>
